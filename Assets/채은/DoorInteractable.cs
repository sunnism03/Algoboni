...
public class DoorInteractable : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        {
            simpleInteractable.selectEntered.AddListener(OnDoorOpen);
        }
    }
    ...
    private void OnDisable()
    {
        if (simpleInteractable != null)
        {
            simpleInteractable.selectEntered.RemoveListener(OnDoorOpen);
        }
    }

    private void OnDoorOpen(SelectEnterEventArgs args)
    {
        if (isOpened) return; 
        isOpened = true;
